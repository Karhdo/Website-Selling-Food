                    ...
                    <div class="filter-price">
                        ...
                        <div class="filter-price__slider">
                            ...
                            <div class="btn-filter">
                                <b-button variant="success">Lọc</b-button>
                            </div>
                        </div>
                    </div>
                    <div class="selling-products">
                        ...
                        <ul class="selling-products__list">
                            <li class="selling-products__item">
                                <a class="selling-products__item-link" href="#">
                                    <div class="selling-products__item-img">
                                        <img class="selling-products__item-img" src="http://localhost:8000/storage/product/3/iTHUoFmEhcs15y4kexr4.jpg" alt="" />
                                    </div>
                                    <div class="selling-products__item-info">
                                        <span class="name">Dâu tây Đà Lạt</span>
                    ...
                    <b-row>
                        <b-col class="home-products-list">
                            <div v-for="product in products.data" :key="product.id" class="home-products-item">
                                ...
                                <button class="home-products-item__btn">Thêm vào giỏ</button>
...
export default {
    ...
    methods: {
        ...
        getListCategory() {
            axios.get('api/frontend/store/listcategory')
            .then(response => {
