...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    removeProduct: function removeProduct(index, id, totalMoney) {
      var _this = this;
      ...
      axios.get("ProductCart/delete-cart", {
        ...
        if (response.data.code == 200) {
          _this.totalMoneyUpdate = totalMoney - _this.cartProducts[index].price * _this.cartProducts[index].quantity;
          _app_js__WEBPACK_IMPORTED_MODULE_2__["eventBus"].$emit('totalMoneyUpdate', _this.totalMoneyUpdate);
          that.splice(index, 1);
        }
    ...
    updateCart: function updateCart(totalMoney) {
      var _this2 = this;

      var request = {};
      var that = this.cartProducts;
      this.cartProducts.forEach(function (element, index) {
      ...
      axios.get("ProductCart/update-cart", {
        ...
        if (response.data.code === 200) {
          ...
          _this2.totalMoneyUpdate = totalMoney;
          _app_js__WEBPACK_IMPORTED_MODULE_2__["eventBus"].$emit('totalMoneyUpdate', _this2.totalMoneyUpdate);
        }
      })["catch"](function (error) {});
    },
                        ...
                        [
                          ...
                          _c("td", [
                            _c("img", {
                              ...
                              attrs: {
                                src: _vm.base_url + cartProduct.image_path,
                                alt: "",
                              },
                            }),
                          ]),
